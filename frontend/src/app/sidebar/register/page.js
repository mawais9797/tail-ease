"use client";
import { Formik, Form, Field, FormControlLabel, ErrorMessage } from "formik";
    ...
    >
      <Card sx={{ zIndex: 1, overflowX: "hidden" }}>
        ...
        >
          ...
          <Box sx={{ mb: 6 }}>
            <Typography>Pets Deserve The Best 🚀</Typography>
          ...
          >
            {({ isSubmitting }) => (
              <Form noValidate>
                ...
                />
                {/* <FormControlLabel
                  control={<Field type="checkbox" name="agree" as={Checkbox} />}
                  label={
                    <Fragment>
